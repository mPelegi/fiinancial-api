...
namespace Fiinancial.Api.Service.Validations.Base
{
    public abstract class BaseValidator<T> : AbstractValidator<T>
    {
        ...
        protected string MensagemValorPositivo(string campo) => $"O campo {campo} deve conter um valor maior ou igual a zero";
    }
}
